...
const img400x300 = 'data:image/svg+xml;charset=UTF-8,%3Csvg%20width%3D%22400%22%20height%3D%22300%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20400%20300%22%20preserveAspectRatio%3D%22none%22%3E%3Cdefs%3E%3Cstyle%20type%3D%22text%2Fcss%22%3E%23holder_15ac809d7b8%20text%20%7B%20fill%3Argba(255%2C255%2C255%2C.75)%3Bfont-weight%3Anormal%3Bfont-family%3AHelvetica%2C%20monospace%3Bfont-size%3A20pt%20%7D%20%3C%2Fstyle%3E%3C%2Fdefs%3E%3Cg%20id%3D%22holder_15ac809d7b8%22%3E%3Crect%20width%3D%22400%22%20height%3D%22300%22%20fill%3D%22%23777%22%3E%3C%2Frect%3E%3Cg%3E%3Ctext%20x%3D%22149%22%20y%3D%22159%22%3E400x300%3C%2Ftext%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E';
...
<div className="text-center">
  ...
  <P className="figure-img my-2">Image figure</P>
  <Img thumbnail alt="..." src={img200x200} className="my-2" />
  <P className="figure-img my-2">Image figure</P>
  <Img thumbnail alt="..." src={img200x200} className="my-2" />
  <P className="figure-img my-2">Image figure</P>
  <Img alt="..." src={img400x300} className="rounded mx-auto d-block" />
  <div className="text-center my-2">
    <Img alt="..." src={img400x300} className="rounded" />
  </div>
</div>
```
