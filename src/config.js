...
v['$form-check-margin-bottom'] = ((rmUnit(v['$spacer-y'], UNIT.REM) * 0.75) + UNIT.REM);
v['$form-text-margin-top'] = ((rmUnit(v['$spacer-y'], UNIT.REM) * 0.25) + UNIT.REM);
...
v['$card-columns-sm-up-column-gap'] = '1.25rem';
...
// v['$thumbnail-caption-color'] = v['$text-color'];
// v['$thumbnail-caption-padding'] = '9px';
// v['$modal-content-fallback-border-color'] = '#999';
// v['$popover-arrow-outer-fallback-color'] = 'darken(@popover-fallback-border-color, 20%)';
// v['$popover-fallback-border-color'] = '#ccc';
// v['$pager-bg'] = v['$pagination-bg'];
// v['$pager-border'] = v['$pagination-border'];
// v['$pager-border-radius'] = '15px';
// v['$pager-hover-bg'] = v['$pagination-hover-bg'];
// v['$pager-active-bg'] = v['$pagination-active-bg'];
// v['$pager-active-color'] = v['$pagination-active-color'];
// v['$navbar-height'] = '50px';
// v['$navbar-margin-bottom'] = v['$line-height-computed'];
// v['$navbar-border-radius'] = v['$border-radius-base'];
// v['$navbar-padding-horizontal'] = 'floor((@grid-gutter-width / 2))';
// v['$navbar-padding-vertical'] = '((@navbar-height - @line-height-computed) / 2)';
// v['$navbar-collapse-max-height'] = '340px';
// v['$navbar-default-color'] = '#777';
// v['$navbar-default-bg'] = '#f8f8f8';
// v['$navbar-default-border'] = 'darken(@navbar-default-bg, 6.5%)';
// v['$navbar-default-link-color'] = '#777';
// v['$navbar-default-link-hover-color'] = '#333';
// v['$navbar-default-link-hover-bg'] = 'transparent';
// v['$navbar-default-link-active-color'] = '#555';
// v['$navbar-default-link-active-bg'] = 'darken(@navbar-default-bg, 6.5%)';
// v['$navbar-default-link-disabled-color'] = '#ccc';
// v['$navbar-default-link-disabled-bg'] = 'transparent';
// v['$navbar-default-brand-color'] = v['$navbar-default-link-color'];
// v['$navbar-default-brand-hover-color'] = 'darken(@navbar-default-brand-color, 10%)';
// v['$navbar-default-brand-hover-bg'] = 'transparent';
// v['$navbar-default-toggle-hover-bg'] = '#ddd';
// v['$navbar-default-toggle-icon-bar-bg'] = '#888';
// v['$navbar-default-toggle-border-color'] = '#ddd';
// v['$navbar-inverse-color'] = 'lighten(@gray-light, 15%)';
// v['$navbar-inverse-bg'] = '#222';
// v['$navbar-inverse-border'] = 'darken(@navbar-inverse-bg, 10%)';
// v['$navbar-inverse-link-color'] = 'lighten(@gray-light, 15%)';
// v['$navbar-inverse-link-hover-color'] = '#fff';
// v['$navbar-inverse-link-hover-bg'] = 'transparent';
// v['$navbar-inverse-link-active-color'] = v['$navbar-inverse-link-hover-color'];
// v['$navbar-inverse-link-active-bg'] = 'darken(@navbar-inverse-bg, 10%)';
// v['$navbar-inverse-link-disabled-color'] = '#444';
// v['$navbar-inverse-link-disabled-bg'] = 'transparent';
// v['$navbar-inverse-brand-color'] = v['$navbar-inverse-link-color'];
// v['$navbar-inverse-brand-hover-color'] = '#fff';
// v['$navbar-inverse-brand-hover-bg'] = 'transparent';
// v['$navbar-inverse-toggle-hover-bg'] = '#333';
// v['$navbar-inverse-toggle-icon-bar-bg'] = '#fff';
// v['$navbar-inverse-toggle-border-color'] = '#333';
// v['$dropdown-header-color'] = v['$gray-light'];
// v['$dropdown-caret-color'] = '#000';
// v['$dropdown-fallback-border'] = '#ccc';
// v['$legend-color'] = v['$gray-dark'];
// v['$legend-border-color'] = '#e5e5e5';
// v['$screen-xs'] = '480px';
// v['$screen-xs-min'] = v['$screen-xs'];
// v['$screen-phone'] = v['$screen-xs-min'];
// v['$screen-sm'] = '768px';
// v['$screen-sm-min'] = v['$screen-sm'];
// v['$screen-tablet'] = v['$screen-sm-min'];
// v['$screen-md'] = '992px';
// v['$screen-md-min'] = v['$screen-md'];
// v['$screen-desktop'] = v['$screen-md-min'];
// v['$screen-lg'] = '1200px';
// v['$screen-lg-min'] = v['$screen-lg'];
// v['$screen-lg-desktop'] = v['$screen-lg-min'];
// v['$screen-xs-max'] = '(@screen-sm-min - 1)';
// v['$screen-sm-max'] = '(@screen-md-min - 1)';
// v['$screen-md-max'] = '(@screen-lg-min - 1)';
// v['$-tablet'] = '(720px + @grid-gutter-width)';
// v['$container-sm'] = v['$container-tablet'];
// v['$container-desktop'] = '(940px + @grid-gutter-width)';
// v['$container-md'] = v['$container-desktop'];
// v['$container-large-desktop'] = '(1140px + @grid-gutter-width)';
// v['$label-default-bg'] = v['$gray-light'];
// v['$label-primary-bg'] = v['$brand-primary'];
// v['$label-success-bg'] = v['$brand-success'];
// v['$label-info-bg'] = v['$brand-info'];
// v['$label-warning-bg'] = v['$brand-warning'];
// v['$label-danger-bg'] = v['$brand-danger'];
// v['$label-color'] = '#fff';
// v['$label-link-hover-color'] = '#fff';
// v['$panel-bg'] = '#fff';
// v['$panel-body-padding'] = '15px';
// v['$panel-heading-padding'] = '10px 15px';
// v['$panel-footer-padding'] = v['$panel-heading-padding'];
// v['$panel-border-radius'] = v['$border-radius-base'];
// v['$panel-inner-border'] = '#ddd';
// v['$panel-footer-bg'] = '#f5f5f5';
// v['$panel-default-text'] = v['$gray-dark'];
// v['$panel-default-border'] = '#ddd';
// v['$panel-default-heading-bg'] = '#f5f5f5';
// v['$panel-primary-text'] = '#fff';
// v['$panel-primary-border'] = v['$brand-primary'];
// v['$panel-primary-heading-bg'] = v['$brand-primary'];
// v['$panel-success-text'] = v['$state-success-text'];
// v['$panel-success-border'] = v['$state-success-border'];
// v['$panel-success-heading-bg'] = v['$state-success-bg'];
// v['$panel-info-text'] = v['$state-info-text'];
// v['$panel-info-border'] = v['$state-info-border'];
// v['$panel-info-heading-bg'] = v['$state-info-bg'];
// v['$panel-warning-text'] = v['$state-warning-text'];
// v['$panel-warning-border'] = v['$state-warning-border'];
// v['$panel-warning-heading-bg'] = v['$state-warning-bg'];
// v['$panel-danger-text'] = v['$state-danger-text'];
// v['$panel-danger-border'] = v['$state-danger-border'];
// v['$panel-danger-heading-bg'] = v['$state-danger-bg'];
// v['$well-bg'] = '#f5f5f5';
// v['$well-border'] = 'darken(@well-bg, 7%)';
// v['$badge-color'] = '#fff';
// v['$badge-link-hover-color'] = '#fff';
// v['$badge-bg'] = v['$gray-light'];
// v['$badge-active-color'] = v['$link-color'];
// v['$badge-active-bg'] = '#fff';
// v['$badge-font-weight'] = 'bold';
// v['$badge-line-height'] = '1';
// v['$badge-border-radius'] = '10px';
// v['$component-offset-horizontal'] = '180px';
// v['$text-muted'] = v['$gray-light'];
// v['$abbr-border-color'] = v['$gray-light'];
// v['$headings-small-color'] = v['$gray-light'];
// v['$blockquote-small-color'] = v['$gray-light'];
// v['$blockquote-font-size'] = '(@font-size-base * 1.25)';
// v['$blockquote-border-color'] = v['$gray-lighter'];
// v['$page-header-border-color'] = v['$gray-lighter'];
// v['$dl-horizontal-offset'] = v['$component-offset-horizontal'];
// v['$dl-horizontal-breakpoint'] = v['$grid-float-breakpoint'];
// v['$hr-border'] = v['$gray-lighter'];
// v['$text-color'] = v['$gray-dark'];
