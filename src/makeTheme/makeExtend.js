...
export default function makeExtend(original = makeOriginal(), userTheme = {}) {
  ...
  v['$motion-rotate-in-degree'] = u['$motion-rotate-in-degree'] || v['$motion-degree']['lg'];
  v['$motion-rotate-left-degree'] = u['$motion-rotate-left-degree'] || v['$motion-degree']['xs'];
  v['$motion-rotate-right-degree'] = u['$motion-rotate-right-degree'] || v['$motion-degree']['xs'];
  v['$motion-rotate-up-left-degree'] = u['$motion-rotate-up-left-degree'] || v['$motion-degree']['xs'];
  v['$motion-rotate-up-right-degree'] = u['$motion-rotate-up-right-degree'] || v['$motion-degree']['xs'];
  ...
  v['$motion-hue-rotate-degree'] = u['$motion-hue-rotate-degree'] || v['$motion-degree']['xl'];
