...
import themeH4 from './theme';

const defaultProps = { theme: themeH4 };

class H4Unstyled extends React.Component { // eslint-disable-line react/prefer-stateless-function
