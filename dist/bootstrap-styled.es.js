...
var AlertUnstyledWithTheme = withTheme(AlertUnstyled);

var Alert = styled(AlertUnstyledWithTheme).withConfig({
  displayName: 'Alert'
})(['', ''], function (props) {
