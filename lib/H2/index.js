...
var H2Unstyled = function (_React$Component) {
  _inherits(H2Unstyled, _React$Component);

  function H2Unstyled() {
    _classCallCheck(this, H2Unstyled);

    return _possibleConstructorReturn(this, (H2Unstyled.__proto__ || Object.getPrototypeOf(H2Unstyled)).apply(this, arguments));
  }

  _createClass(H2Unstyled, [{
    key: 'render',
...
H2Unstyled.defaultProps = defaultProps;
H2Unstyled.propTypes = propTypes;


var H2 = (0, _styledComponents2.default)(H2Unstyled).withConfig({
  displayName: 'H2'
})(['', ''], function (props) {
