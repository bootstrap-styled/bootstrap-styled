...
var makeTheme = exports.makeTheme = function makeTheme() {
  ...
  v['$enable-shadows'] = (0, _utils.allowFalseValue)(u['$enable-rounded'], false);
  v['$enable-hover-media-query'] = (0, _utils.allowFalseValue)(u['$enable-rounded'], true);
  v['$enable-transitions'] = (0, _utils.allowFalseValue)(u['$enable-rounded'], true);
