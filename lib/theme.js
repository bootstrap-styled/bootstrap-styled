...
var detectUnit = _mathUtils.unitUtils.detectUnit,
    rmUnit = _mathUtils.unitUtils.rmUnit,
...
// otherwise use makeTheme to build a theme
...
function makeTheme() {
  ...
  v['$btn-box-shadow'] = u['$btn-box-shadow'] || 'inset 0 1px 0 rgba(' + v['$white'] + ',.15), 0 1px 1px ' + (0, _color2.default)(v['$black']).alpha(0.075).toString();
  ...
  // v['$navbar-dark-toggler-bg'] = `url('data:image/svg+xml;charset=utf8,%3Csvg viewBox=\'0 0 32 32\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath stroke=\'rgba(255,255,255,.5)\' stroke-width=\'2\' stroke-linecap=\'round\' stroke-miterlimit=\'10\' d=\'M4 8h24M4 16h24M4 24h24\'/%3E%3C/svg%3E')`;
