...
describe('<Modal />', function () {
  ...
  it('should render with the class "modal-dialog"', function () {
    isOpen = true;
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle }));
  ...
  it('should render with the backdrop with the class "modal-backdrop" when backdrop is "static"', function () {
    isOpen = true;
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle, backdrop: 'static' }));
    expect(document.getElementsByClassName('modal-backdrop').length).toBe(1);
    wrapper.unmount();
  });
  it('should not render with the backdrop with the class "modal-backdrop" when backdrop is "false"', function () {
    isOpen = true;
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle, backdrop: false }));
    expect(document.getElementsByClassName('modal-dialog').length).toBe(1);
  ...
  it('should render with class "modal-dialog" and have custom class name if provided', function () {
    isOpen = true;
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle, className: 'my-custom-modal' }));
    expect(document.getElementsByClassName('modal-dialog').length).toBe(1);
  ...
  it('should render with class "modal" and have custom class name if provided with modalClassName', function () {
    isOpen = true;
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle, modalClassName: 'my-custom-modal' }));
  ...
  it('should render with custom class name if provided with wrapClassName', function () {
    isOpen = true;
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle, wrapClassName: 'my-custom-modal' }));
    expect(document.getElementsByClassName('my-custom-modal').length).toBe(1);
    wrapper.unmount();
  });
  ...
  it('should render with class "modal-content" and have custom class name if provided with contentClassName', function () {
    isOpen = true;
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle, contentClassName: 'my-custom-modal' }));
  ...
  it('should render with class "modal-backdrop" and have custom class name if provided with backdropClassName', function () {
    isOpen = true;
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle, backdropClassName: 'my-custom-modal' }));
  ...
  it('should render with the class modal-md when size is passed', function () {
    isOpen = true;
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle, size: 'md' }));
    expect(document.getElementsByClassName('modal-dialog').length).toBe(1);
  ...
  it('should toggle modal', function () {
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(
      ...
      _react2.default.createElement(_index2.default, { isOpen: isOpen, onBackdrop: toggle })
    ));
    expect(document.getElementsByClassName('modal').length).toBe(0);
    expect(document.getElementsByClassName('modal-backdrop').length).toBe(0);
