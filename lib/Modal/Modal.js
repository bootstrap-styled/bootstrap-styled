...
var ModalUnstyled = function (_React$Component) {
  ...
  function ModalUnstyled(props) {
    ...
    _this.destroy = function () {
      ...
      (0, _bootstrapStyledUtils.setScrollbarWidth)(_this.originalBodyPadding);
    };
  ...
  _createClass(ModalUnstyled, [{
    ...
    value: function show() {
      ...
      this.originalBodyPadding = (0, _bootstrapStyledUtils.getOriginalBodyPadding)();

      (0, _bootstrapStyledUtils.conditionallyUpdateScrollbar)();
...
ModalUnstyled.propTypes = {
  ...
  onUnlock: _propTypes2.default.func,
