...
var H3Unstyled = function (_React$Component) {
  _inherits(H3Unstyled, _React$Component);

  function H3Unstyled() {
    _classCallCheck(this, H3Unstyled);

    return _possibleConstructorReturn(this, (H3Unstyled.__proto__ || Object.getPrototypeOf(H3Unstyled)).apply(this, arguments));
  }

  _createClass(H3Unstyled, [{
    key: 'render',
...
H3Unstyled.defaultProps = defaultProps;
H3Unstyled.propTypes = propTypes;


var H3 = (0, _styledComponents2.default)(H3Unstyled).withConfig({
  displayName: 'H3'
})(['', ''], function (props) {
