...
var defaultProps = exports.defaultProps = {
  ...
  transition: _extends({}, _Fade.defaultProps, {
    unmountOnExit: true
  })
};
...
var propTypes = exports.propTypes = {
  ...
  transition: _propTypes2.default.shape({
    FadeProptypes: _propTypes2.default.object,
...
var AlertUnstyled = function (_React$Component) {
  ...
  _createClass(AlertUnstyled, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'autoHideDuration', 'toggle']),
      ...
      var classes = (0, _mapToCssModules2.default)((0, _classnames2.default)(className, 'alert', 'alert-' + color, { 'alert-dismissible': uncontrolled || onClick }), cssModule);
      ...
      return _react2.default.createElement(
        ...
        (uncontrolled || onClick) && _react2.default.createElement(_Close2.default, { onDismiss: this.toggle }),
        children
      );
    }
  }]);
...
var Alert = (0, _styledComponents2.default)(AlertUnstyled).withConfig({
  displayName: 'Alert'
=======
var AlertHoc = (0, _styledComponents2.default)(AlertUnstyled).withConfig({
  displayName: 'Alert__AlertHoc'
>>>>>>> 91516b1cf35ff680ca0f41862fee0606510696b9
})(['', ''], function (props) {
...
var Alert = (0, _styledComponents.withTheme)(AlertHoc);
