...
exports.TooltipUnstyled = exports.defaultProps = exports.propTypes = undefined;
...
var propTypes = exports.propTypes = {
  ...
  theme: _propTypes2.default.shape({
    '$zindex-tooltip': _propTypes2.default.string,
    '$tooltip-max-width': _propTypes2.default.string,
    '$tooltip-color': _propTypes2.default.string,
    '$tooltip-bg': _propTypes2.default.string,
    '$tooltip-opacity': _propTypes2.default.string,
    '$tooltip-padding-y': _propTypes2.default.string,
    '$tooltip-padding-x': _propTypes2.default.string,
    '$tooltip-margin': _propTypes2.default.string,
    '$tooltip-arrow-width': _propTypes2.default.string,
    '$tooltip-arrow-color': _propTypes2.default.string,
...
TooltipUnstyled.defaultProps = defaultProps;
