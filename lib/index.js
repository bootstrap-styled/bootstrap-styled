...
var HeaderNavBarCollapse = compCollapse(HeaderNavBar);
var HeaderNavBarSlide = compSlide(HeaderNavBar);
...
Object.keys(mixins).forEach(function (key) {
  module.exports[key + 'Mixins'] = mixins[key];
});
Object.keys(utilities).forEach(function (key) {
  module.exports[key + 'Utils'] = utilities[key];
});