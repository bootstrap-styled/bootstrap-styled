  ...
  _createClass(InputGroupButton, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          attributes = _objectWithoutProperties(_props, ['className', 'cssModule', 'tag', 'children', 'groupClassName', 'groupAttributes']);

      if (typeof children === 'string') {
        var groupClasses = (0, _mapToCssModules2.default)((0, _classnames2.default)(groupClassName, 'input-group-btn'), cssModule);
      ...
      var classes = (0, _mapToCssModules2.default)((0, _classnames2.default)(className, 'input-group-btn'), cssModule);
