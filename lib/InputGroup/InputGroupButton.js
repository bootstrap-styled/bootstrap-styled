  ...
  _createClass(InputGroupButton, [{
    ...
    value: function render() {
      ...
      if (typeof children === 'string') {
        var groupClasses = (0, _tools.mapToCssModules)((0, _classnames2.default)(groupClassName, 'input-group-btn'), cssModule);
      ...
      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'input-group-btn'), cssModule);
