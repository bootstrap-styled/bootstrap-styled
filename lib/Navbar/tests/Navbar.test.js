...
describe('<Navbar />', function () {
  ...
  it('should have a class navbar-toggleable-md with a theme', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { toggleable: 'md' }));
  ...
  it('should have a class navbar-toggleable with a theme', function () {
    var renderedComponent = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { toggleable: true }));
