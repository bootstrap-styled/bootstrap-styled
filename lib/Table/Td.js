...
var propTypes = exports.propTypes = {
  ...
  color: _propTypes2.default.oneOf(['active', 'success', 'info', 'warning', 'danger', ''])
};
  ...
  _createClass(Td, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          attributes = _objectWithoutProperties(_props, ['className', 'color', 'children']);

      var classes = (0, _classnames2.default)(className, color ? 'table-' + color : false);
