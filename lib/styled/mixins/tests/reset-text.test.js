...
describe('bootstrap reset-text mixins', function () {
  it('resetText should return a css', function () {
    var css = resetText(defaultProps['$font-family-base'], defaultProps['$font-weight-normal'], defaultProps['$line-height-base']);
  ...
  it('resetText should have arguments', function () {
    var css = resetText();
    expect(fromJS({ css: css }).hashCode()).toEqual(-552236203);
  });
});