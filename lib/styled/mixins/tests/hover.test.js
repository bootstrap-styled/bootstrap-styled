...
describe('bootstrap hover mixins', function () {
  ...
  it('hover should have hoverFocus', function () {
    var css = _hover.hover.hoverFocus(_hover.defaultProps['$enable-hover-media-query'], 'cursor: pointer;\n      opacity: .5;');
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-75696186);
  });
  it('hover should have plainHoverFocus', function () {
    var css = _hover.hover.plainHoverFocus(_hover.defaultProps['$enable-hover-media-query'], 'cursor: pointer;\n      opacity: .5;');
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(507113767);
  });
  it('hover should have hoverFocusActive', function () {
    var css = _hover.hover.hoverFocusActive(_hover.defaultProps['$enable-hover-media-query'], 'cursor: pointer;\n      opacity: .5;');
