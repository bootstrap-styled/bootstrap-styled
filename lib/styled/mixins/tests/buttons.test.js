...
describe('bootstrap button mixins', function () {
  it('buttonVariant should return a css without shadows', function () {
    var css = (0, _buttons.buttonVariant)(_buttons.defaultProps['$enable-shadows'], '#f00', '#0f0', '#0ff', _buttons.defaultProps['$btn-active-box-shadow']);
    expect(css).not.toContain('undefined');
    expect(css).not.toContain('null');
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(1041641618);
  });
  it('buttonVariant should return a css with shadows', function () {
    var css = (0, _buttons.buttonVariant)(!_buttons.defaultProps['$enable-shadows'], '#f00', '#0f0', '#0ff', _buttons.defaultProps['$btn-active-box-shadow']);
    expect(css).not.toContain('undefined');
    expect(css).not.toContain('null');
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-227865912);
  });
  it('buttonVariant should return a css by default', function () {
    var css = (0, _buttons.buttonVariant)();
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(413533465);
  });
  it('buttonOutlineVariant should return a css', function () {
    var css = (0, _buttons.buttonOutlineVariant)('#f00', '#0f0');
    expect(css).not.toContain('undefined');
    expect(css).not.toContain('null');
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-275320956);
  });
  it('buttonOutlineVariant should return a css by default', function () {
    var css = (0, _buttons.buttonOutlineVariant)();
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-41725614);
  });
  ...
  it('button should return a a css', function () {
    ...
    expect(css).not.toContain('undefined');
    expect(css).not.toContain('null');
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(972408415);
  });
