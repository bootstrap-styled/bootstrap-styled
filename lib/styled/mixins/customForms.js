...
export function customForms() {
  ...
  var selectBorderWidth = unitUtils.math.multiply($borderWidth, 2);
  var customSelectPaddingRight = unitUtils.math.addition($customSelectPaddingY, $customSelectIndicatorPadding);
  var lineHeightBaseMinusCustomControlIndicatorSize = unitUtils.math.subtract($lineHeightBase, $customControlIndicatorSize);
