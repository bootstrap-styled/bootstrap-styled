...
function buttonVariant() {
  ...
  var btnBoxShadow = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : defaultProps['$btn-box-shadow'];
  ...
  return '\n    color: ' + buttonColor + ';\n    background-color: ' + background + ';\n    border-color: ' + border + ';\n    ' + (0, _boxShadow.boxShadow)(enableShadows, btnBoxShadow) + '\n  \n    ' + (0, _hover.hover)('\n      color: ' + buttonColor + ';\n      background-color: ' + activeBackground + ';\n      border-color: ' + activeBorder + ';\n    ') + '\n  \n    &:focus,\n    &.focus {\n      ' + (0, _conditional.ifElse)(enableShadows, 'box-shadow: ' + btnBoxShadow + ', 0 0 0 2px ' + (0, _color2.default)(border).alpha(0.5).toString() + ';', 'box-shadow: 0 0 0 2px ' + (0, _color2.default)(border).alpha(0.5).toString() + ';') + '\n    }\n  \n    &:active,\n    &.active,\n    .show > &.dropdown-toggle {\n      color: ' + buttonColor + ';\n      background-color: ' + activeBackground + ';\n      border-color: ' + activeBorder + ';\n      /* Remove the gradient for the pressed/active state */\n      background-image: none;\n      ' + (0, _boxShadow.boxShadow)(enableShadows, btnActiveBoxShadow) + '\n    }\n  \n    &.disabled,\n    &:disabled {\n      background-color: ' + background + ';\n      border-color: ' + border + ';\n    }\n  ';
}
