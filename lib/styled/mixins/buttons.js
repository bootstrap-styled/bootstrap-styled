...
function buttonVariant() {
  ...
  var activeBackground = (0, _color2.default)(background).darken(0.1).hex();
  var activeBorder = (0, _color2.default)(border).darken(0.12).hex();

  return '\n    color: ' + buttonColor + ';\n    background-color: ' + background + ';\n    border-color: ' + border + ';\n    ' + (0, _boxShadow.boxShadow)(enableShadows, btnActiveBoxShadow) + '\n  \n    ' + (0, _hover.hover)('\n      color: ' + buttonColor + ';\n      background-color: ' + activeBackground + ';\n          border-color: ' + activeBorder + ';\n    ') + '\n  \n    &:focus,\n    &.focus {\n      color: ' + buttonColor + ';\n      background-color: ' + activeBackground + ';\n          border-color: ' + activeBorder + ';\n    }\n  \n    &:active,\n    &.active,\n    .open > &.dropdown-toggle {\n      color: ' + buttonColor + ';\n      background-color: ' + activeBackground + ';\n          border-color: ' + activeBorder + ';\n      /* Remove the gradient for the pressed/active state */\n      background-image: none;\n    ' + (0, _boxShadow.boxShadow)(enableShadows, btnActiveBoxShadow) + '\n  \n      &:hover,\n      &:focus,\n      &.focus {\n        color: ' + buttonColor + ';\n        background-color: ' + (0, _color2.default)(background).darken(0.17).toString() + ';\n            border-color: ' + (0, _color2.default)(border).darken(0.25).toString() + ';\n      }\n    }\n  \n    &.disabled,\n    &:disabled {\n      &:focus,\n      &.focus {\n        background-color: ' + background + ';\n            border-color: ' + border + ';\n      }\n      ' + (0, _hover.hover)('\n        background-color: ' + background + ';\n            border-color: ' + border + ';\n      ') + '\n    }\n  ';
}

function buttonOutlineVariant(buttonColor) {
  var buttonColorHover = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '#fff';

  return '\n    color: ' + buttonColor + ';\n    background-image: none;\n    background-color: transparent;\n    border-color: ' + buttonColor + ';\n  \n    ' + (0, _hover.hover)('\n      color: ' + buttonColorHover + ';\n      background-color: ' + buttonColor + ';\n          border-color: ' + buttonColor + ';\n    ') + '\n  \n    &:focus,\n    &.focus {\n      color: ' + buttonColorHover + ';\n      background-color: ' + buttonColor + ';\n          border-color: ' + buttonColor + ';\n    }\n  \n    &:active,\n    &.active,\n    & .open > &.dropdown-toggle {\n      color: ' + buttonColorHover + ';\n      background-color: ' + buttonColor + ';\n          border-color: ' + buttonColor + ';\n  \n      &:hover,\n      &:focus,\n      &.focus {\n        color: ' + buttonColorHover + ';\n        background-color: ' + (0, _color2.default)(buttonColor).darken(0.17).toString() + ';\n            border-color: ' + (0, _color2.default)(buttonColor).darken(0.25).toString() + ';\n      }\n    }\n  \n    &.disabled,\n    &:disabled {\n      &:focus,\n      &.focus {\n        border-color: ' + (0, _color2.default)(buttonColor).lighten(0.2).toString() + ';\n      }\n      ' + (0, _hover.hover)('\n        border-color: ' + (0, _color2.default)(buttonColor).lighten(0.2).toString() + ';\n      ') + '\n    }\n  ';
}
