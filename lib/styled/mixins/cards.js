...
export function cardInverse() {
  ...
  var cardBackground = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : defaultProps['$card-inverse-bg-color'];
  var cardBorder = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : defaultProps['$card-inverse-border-color'];
