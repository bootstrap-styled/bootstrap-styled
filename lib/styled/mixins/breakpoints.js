...
//    md
export function breakpointNext(name) {
...
//    544px
export function breakpointMin(name) {
  var breakpoints = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultProps['$grid-breakpoints'];
...
//    767px
export function breakpointMax(name) {
  var breakpoints = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultProps['$grid-breakpoints'];

  var next = breakpointNext(name, breakpoints);
  if (next) {
    var min = unitUtils.rmUnit(breakpointMin(next, breakpoints), unitUtils.UNIT.PX);
...
//    "-sm"
export function breakpointInfix(name) {
  var breakpoints = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultProps['$grid-breakpoints'];
...
export function mediaBreakpointBetween(lower, upper) {
...
export function mediaBreakpointOnly(name) {
  var breakpoints = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultProps['$grid-breakpoints'];
  var content = arguments[2];
...
export default {
  ...
  breakpointNext: breakpointNext,
  breakpointMin: breakpointMin,
  breakpointMax: breakpointMax,
  breakpointInfix: breakpointInfix,
  mediaBreakpointUp: mediaBreakpointUp,
  mediaBreakpointDown: mediaBreakpointDown,
  mediaBreakpointBetween: mediaBreakpointBetween,
  mediaBreakpointOnly: mediaBreakpointOnly
};