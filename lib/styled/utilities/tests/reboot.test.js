...
describe('bootstrap reboot utility', function () {
  it('getGlobalStyleNoBootstrapProvider should return a set of global styles', function () {
    var css = (0, _reboot.getGlobalStyleNoBootstrapProvider)(_theme2.default['$font-family-base'], _theme2.default['$font-size-base'], _theme2.default['$font-weight-base'], _theme2.default['$line-height-base'], _theme2.default['$body-color'], _theme2.default['$body-bg']);
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-683494948);
  });
  it('getGlobalStyles should return a set of global styles', function () {
    var css = (0, _reboot.getGlobalStyles)();
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-275619875);
  });
