...
describe('bootstrap reboot utility', function () {
  it('getRebootUtils should return a set of global styles', function () {
    var css = (0, _reboot.getRebootUtils)(_theme2.default['$font-family-base'], _theme2.default['$font-size-base'], _theme2.default['$font-weight-base'], _theme2.default['$line-height-base'], _theme2.default['$body-color'], _theme2.default['$body-bg']);
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-478980935);
  });
  it('getRebootUtils should return a set of global styles without params', function () {
    var css = (0, _reboot.getRebootUtils)();
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-478980935);
  });
  it('getGlobalStyles should return a set of global styles', function () {
    ...
    expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-663578906);
  });
