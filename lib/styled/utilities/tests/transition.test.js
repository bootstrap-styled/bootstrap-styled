...
describe('bootstrap transition mixins', function () {
  describe('getTransitionUtils', function () {
    it('should return a css utility', function () {
      ...
      expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-407098760);
    });
    it('should have parameters', function () {
      var css = (0, _transition.getTransitionUtilities)();
      expect(css).not.toContain('undefined');
      expect(css).not.toContain('null');
      expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-303544800);
    });
  });
  ...
  describe('swapFade', function () {
    it('should return a css with defaultProps', function () {
      var css = (0, _transition.swapFade)();
      expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(1010683774);
    });
    it('should return a css with transition', function () {
      var enableTransitions = true;
      var css = (0, _transition.swapFade)(enableTransitions, 'opacity 500ms ease');
      expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-575218961);
    });
    it('should return a css without transition', function () {
      var enableTransitions = false;
      var css = (0, _transition.swapFade)(enableTransitions, 'opacity 500ms ease');
      expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(-454224996);
    });
  });
  describe('makeReactTransition', function () {
    it('should return a css with defaultProps', function () {
      var css = (0, _transition.makeReactTransition)();
      expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(457648712);
    });
    it('should return a css adapted to react css transition group ', function () {
      var css = (0, _transition.makeReactTransition)('opacity: 0;', 'opacity: 1;', 'transition: opacity .15s linear;', 'opacity: 1;', 'opacity: 0;', 'transition: opacity .15s linear;');
      expect((0, _immutable.fromJS)({ css: css }).hashCode()).toEqual(147846138);
    });
  });
});