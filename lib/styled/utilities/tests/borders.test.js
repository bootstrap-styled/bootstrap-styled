...
describe('bootstrap borders utility', function () {
  ...
  it('getBordersUtilities without arguments should return a css ', function () {
  ...
  it('rounded with no arguments should return a css ', function () {
    var css = rounded();
    expect(css).not.toContain('undefined');
    expect(css).not.toContain('null');
    expect(fromJS({ css: css }).hashCode()).toEqual(-919223289);
  ...
  it('roundedBottom wihtout arguments should return a css', function () {
  ...
  it('roundedCircle should return a css', function () {
