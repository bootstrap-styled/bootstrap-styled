...
exports.getRebootUtils = getRebootUtils;
...
function getRebootUtils() {
  ...
  return '\n    @global {\n      ' + getGlobalStyles(fontFamilyBase, fontSizeBase, fontWeightBase, lineHeightBase, bodyColor, bodyBg) + '\n    }\n  ';
}
