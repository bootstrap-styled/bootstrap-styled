...
function getTransitionUtilities() {
  ...
  var motionCssPropertyEnter = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : defaultProps['$motion-css-transition-property-enter'];
  var motionTransitionEnter = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : defaultProps['$motion-css-transition-enter'];
  var motionCssPropertyEnterActive = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : defaultProps['$motion-css-transition-property-enter-active'];
  var motionCssPropertyLeave = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : defaultProps['$motion-css-transition-property-leave'];
  var motionTransitionLeave = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : defaultProps['$motion-css-transition-leave'];
  var motionCssPropertyLeaveActive = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : defaultProps['$motion-css-transition-property-leave-active'];
...
function makeReactTransition() {
  var motionCssPropertyEnter = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultProps['$motion-css-property-enter'];
  var motionCssPropertyEnterActive = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultProps['$motion-css-property-enter-active'];
  var motionTransitionEnter = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : defaultProps['$motion-transition-enter'];
  var motionCssPropertyLeave = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : defaultProps['$motion-css-property-leave'];
  var motionCssPropertyLeaveActive = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : defaultProps['$motion-css-property-leave-active'];
