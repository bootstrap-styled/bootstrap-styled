...
exports.bgInverse = exports.bgDanger = exports.bgWarning = exports.bgInfo = exports.bgSuccess = exports.bgPrimary = exports.defaultProps = undefined;
...
var bgPrimary = exports.bgPrimary = function bgPrimary() {
  var bgColor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultProps['$brand-primary'];
  return (0, _backgroundVariant.bgVariant)('.bg-primary', bgColor);
};
var bgSuccess = exports.bgSuccess = function bgSuccess() {
  var bgColor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultProps['$brand-success'];
  return (0, _backgroundVariant.bgVariant)('.bg-success', bgColor);
};
var bgInfo = exports.bgInfo = function bgInfo() {
  var bgColor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultProps['$brand-info'];
  return (0, _backgroundVariant.bgVariant)('.bg-info', bgColor);
};
var bgWarning = exports.bgWarning = function bgWarning() {
  var bgColor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultProps['$brand-warning'];
  return (0, _backgroundVariant.bgVariant)('.bg-warning', bgColor);
};
var bgDanger = exports.bgDanger = function bgDanger() {
  var bgColor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultProps['$brand-danger'];
  return (0, _backgroundVariant.bgVariant)('.bg-danger', bgColor);
};
var bgInverse = exports.bgInverse = function bgInverse() {
  var bgColor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultProps['$brand-inverse'];
  return (0, _backgroundVariant.bgVariant)('.bg-inverse', bgColor);
};
