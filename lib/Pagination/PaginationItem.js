  ...
  _createClass(PaginationItem, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          Tag = _props.tag,
          attributes = _objectWithoutProperties(_props, ['active', 'className', 'cssModule', 'disabled', 'tag']);

      var classes = (0, _mapToCssModules2.default)((0, _classnames2.default)(className, 'page-item', {
        active: active,
        disabled: disabled
      }), cssModule);
