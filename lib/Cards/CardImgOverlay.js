...
var CardImgOverlay = function (_React$Component) {
  _inherits(CardImgOverlay, _React$Component);

  function CardImgOverlay() {
    _classCallCheck(this, CardImgOverlay);

    return _possibleConstructorReturn(this, (CardImgOverlay.__proto__ || Object.getPrototypeOf(CardImgOverlay)).apply(this, arguments));
  }

  _createClass(CardImgOverlay, [{
    key: 'render',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(Tag, _extends({
        className: (0, _mapToCssModules2.default)((0, _classnames2.default)(className, 'card-img-overlay'), cssModule)
      }, attributes));
    }
