...
var propTypes = exports.propTypes = {
  ...
  getRef: _propTypes2.default.oneOfType([_propTypes2.default.func, _propTypes2.default.element]),
  /**
  ...
  _createClass(CardLink, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          attributes = _objectWithoutProperties(_props, ['className', 'cssModule', 'tag', 'getRef']);
