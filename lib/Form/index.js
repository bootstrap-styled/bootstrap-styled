...
var propTypes = {
  ...
  theme: _propTypes2.default.shape({
    ...
    '$gray-dark': _propTypes2.default.string,
    '$gray': _propTypes2.default.string,
    '$gray-light': _propTypes2.default.string,
    '$gray-lighter': _propTypes2.default.string,
    '$gray-lightest': _propTypes2.default.string,
    '$border-width': _propTypes2.default.string,
    '$spacer': _propTypes2.default.string,
    '$spacer-y': _propTypes2.default.string,
    '$grid-breakpoints': _propTypes2.default.shape({
    ...
    '$grid-gutter-widths': _propTypes2.default.shape({
      'xs': _propTypes2.default.string,
      'sm': _propTypes2.default.string,
      'md': _propTypes2.default.string,
      'lg': _propTypes2.default.string,
    ...
    '$line-height-sm': _propTypes2.default.string,
    ...
    '$input-height-sm': _propTypes2.default.string,
    '$input-height-lg': _propTypes2.default.string,
    '$input-transition': _propTypes2.default.string,
    '$form-text-margin-top': _propTypes2.default.string,
    '$form-feedback-margin-top': _propTypes2.default.string,
    '$form-check-margin-bottom': _propTypes2.default.string,
    '$form-check-input-gutter': _propTypes2.default.string,
    '$form-check-input-margin-y': _propTypes2.default.string,
    '$form-check-input-margin-x': _propTypes2.default.string,
    '$form-check-inline-margin-x': _propTypes2.default.string,
    '$form-group-margin-bottom': _propTypes2.default.string,
    ...
    '$custom-control-gutter': _propTypes2.default.string,
    '$custom-control-spacer-x': _propTypes2.default.string,
    '$custom-control-spacer-y': _propTypes2.default.string,
    '$custom-control-indicator-size': _propTypes2.default.string,
    '$custom-control-indicator-bg': _propTypes2.default.string,
    '$custom-control-indicator-bg-size': _propTypes2.default.string,
    '$custom-control-indicator-box-shadow': _propTypes2.default.string,
    '$custom-control-disabled-cursor': _propTypes2.default.string,
    '$custom-control-disabled-indicator-bg': _propTypes2.default.string,
    '$custom-control-disabled-description-color': _propTypes2.default.string,
    '$custom-control-checked-indicator-color': _propTypes2.default.string,
    '$custom-control-checked-indicator-bg': _propTypes2.default.string,
    '$custom-control-checked-indicator-box-shadow': _propTypes2.default.string,
    '$custom-control-focus-indicator-box-shadow': _propTypes2.default.string,
    '$custom-control-active-indicator-color': _propTypes2.default.string,
    '$custom-control-active-indicator-bg': _propTypes2.default.string,
    '$custom-control-active-indicator-box-shadow': _propTypes2.default.string,
    '$custom-checkbox-radius': _propTypes2.default.string,
    '$custom-checkbox-checked-icon': _propTypes2.default.string,
    '$custom-checkbox-indeterminate-bg': _propTypes2.default.string,
    '$custom-checkbox-indeterminate-indicator-color': _propTypes2.default.string,
    '$custom-checkbox-indeterminate-icon': _propTypes2.default.string,
    '$custom-checkbox-indeterminate-box-shadow': _propTypes2.default.string,
    '$custom-radio-radius': _propTypes2.default.string,
    '$custom-radio-checked-icon': _propTypes2.default.string,
    '$custom-select-padding-x': _propTypes2.default.string,
    '$custom-select-padding-y': _propTypes2.default.string,
    '$custom-select-indicator-padding': _propTypes2.default.string,
    '$custom-select-line-height': _propTypes2.default.string,
    '$custom-select-color': _propTypes2.default.string,
    '$custom-select-disabled-color': _propTypes2.default.string,
    '$custom-select-bg': _propTypes2.default.string,
    '$custom-select-disabled-bg': _propTypes2.default.string,
    '$custom-select-bg-size': _propTypes2.default.string,
    '$custom-select-indicator-color': _propTypes2.default.string,
    '$custom-select-indicator': _propTypes2.default.string,
    '$custom-select-border-width': _propTypes2.default.string,
    '$custom-select-border-color': _propTypes2.default.string,
    '$custom-select-border-radius': _propTypes2.default.string,
    '$custom-select-focus-border-color': _propTypes2.default.string,
    '$custom-select-focus-box-shadow': _propTypes2.default.string,
    '$custom-select-sm-font-size': _propTypes2.default.string,
    '$custom-file-height': _propTypes2.default.string,
    '$custom-file-width': _propTypes2.default.string,
    '$custom-file-focus-box-shadow': _propTypes2.default.string,
    '$custom-file-padding-x': _propTypes2.default.string,
    '$custom-file-padding-y': _propTypes2.default.string,
    '$custom-file-line-height': _propTypes2.default.string,
    '$custom-file-color': _propTypes2.default.string,
    '$custom-file-bg': _propTypes2.default.string,
    '$custom-file-border-width': _propTypes2.default.string,
    '$custom-file-border-color': _propTypes2.default.string,
    '$custom-file-border-radius': _propTypes2.default.string,
    '$custom-file-box-shadow': _propTypes2.default.string,
    '$custom-file-button-color': _propTypes2.default.string,
    '$custom-file-button-bg': _propTypes2.default.string,
    '$custom-file-text': _propTypes2.default.object,
    '$form-icon-success-color': _propTypes2.default.string,
    '$form-icon-success': _propTypes2.default.string,
    '$form-icon-warning-color': _propTypes2.default.string,
    '$form-icon-warning': _propTypes2.default.string,
    '$form-icon-danger-color': _propTypes2.default.string,
    '$form-icon-danger': _propTypes2.default.string
  }),
  ...
  _createClass(FormUnstyled, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme']),
          ...
          rest = _objectWithoutProperties(_omit, ['className', 'cssModule', 'inline', 'tag', 'innerRef']);

      var classes = (0, _mapToCssModules2.default)((0, _classnames2.default)(className, inline ? 'form-inline' : false), cssModule);

      return _react2.default.createElement(Tag, _extends({ ref: innerRef, className: classes }, rest));
    }
...
FormUnstyled.defaultProps = defaultProps;
FormUnstyled.propTypes = propTypes;
