  ...
  _createClass(FormCustom, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          attributes = _objectWithoutProperties(_props, ['className', 'cssModule', 'radio', 'children', 'defaultChecked']);
      ...
      var CustomInput = radio ? _react2.default.createElement(_Input2.default, { defaultChecked: defaultChecked, type: 'radio', id: radio.id, name: radio.name, className: 'custom-control-input' }) : _react2.default.createElement(_Input2.default, { defaultChecked: defaultChecked, type: 'checkbox', className: 'custom-control-input' });
