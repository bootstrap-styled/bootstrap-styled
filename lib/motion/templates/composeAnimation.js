  ...
  var HOC = function (_React$Component) {
    ...
    _createClass(HOC, [{
      ...
      value: function componentWillReceiveProps(newProps) {
        if ((0, _tools.toHashCode)(newProps.theme) !== (0, _tools.toHashCode)(this.props.theme)) {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _extends({
            ...
            className: (0, _tools.mapToCssModules)((0, _classnames2.default)({ 'd-inline-block': inline }, className), cssModule)
          }, rest),
          children
        );
      }
