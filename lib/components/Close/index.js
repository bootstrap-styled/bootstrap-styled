  ...
  _createClass(Close, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          theme = _props.theme,
          rest = _objectWithoutProperties(_props, ['className', 'sr-only', 'onDismiss', 'closeLabel', 'cssModule', 'theme']);

      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'close', srOnly ? 'sr-only' : null), cssModule);
...
Close = (0, _styledComponents2.default)(Close).withConfig({
  ...
  componentId: 'Close__Close-90ea7e'
})(['', ''], function (props) {
