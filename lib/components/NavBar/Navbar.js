...
var Navbar = function (_React$Component) {
  ...
  _createClass(Navbar, [{
    ...
    value: function render() {
      ...
      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'navbar', getToggleableClass(toggleable), (_cn = {}, _defineProperty(_cn, 'navbar-toggleable' + (toggleable == 'xs' ? null : '-' + toggleable), toggleable), _defineProperty(_cn, 'navbar-light', light), _defineProperty(_cn, 'navbar-inverse', inverse), _defineProperty(_cn, 'bg-' + color, color), _defineProperty(_cn, 'navbar-full', full), _defineProperty(_cn, 'fixed-' + fixed, fixed), _defineProperty(_cn, 'sticky-' + sticky, sticky), _cn)), cssModule);
