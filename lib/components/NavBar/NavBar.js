  ...
  _createClass(NavBar, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'children', 'theme', 'toggler', 'brand', 'collapse']); // eslint-disable-line no-unused-vars
      ...
      var childrenCollapse = collapse.children,
          classNameCollapse = collapse.className,
          restCollapse = _objectWithoutProperties(collapse, ['children', 'className']);
