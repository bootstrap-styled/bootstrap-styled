...
var NavBar = function (_React$Component) {
  ...
  function NavBar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = NavBar.__proto__ || Object.getPrototypeOf(NavBar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      console.log('toggle state', !_this.state.isOpened);
      _this.setState({
  ...
  _createClass(NavBar, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          brand = _props.brand,
          rest = _objectWithoutProperties(_props, ['className', 'children', 'theme', 'toggler', 'brand']); // eslint-disable-line no-unused-vars


      var NavBarBrand = brand.component,
          textBrand = brand.text,
          classNameBrand = brand.className,
          restBrand = _objectWithoutProperties(brand, ['component', 'text', 'className']);

      var isOpened = this.state.isOpened;
      var sm = theme['$grid-breakpoints'].sm;
      ...
      return React.createElement(
        ...
        textBrand && React.createElement(
          NavBarBrand,
          _extends({ className: cn(classNameBrand, 'navbar-brand') }, restBrand),
          textBrand
        ),
        _jsx(MediaQuery, {
          maxDeviceWidth: sm
