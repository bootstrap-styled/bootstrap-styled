...
var NavBar = function (_React$Component) {
  ...
  _createClass(NavBar, [{
    ...
    value: function render() {
      ...
      var cssClasses = cn('navbar', className, {
      ...
      return contained ? React.createElement(
        ...
        _jsx(Container, {}, void 0, _jsx('div', {
          className: containerClassName
        }, void 0, toggler && _jsx(NavBarToggler, {
          ...
          Collapse,
          _extends({ key: Math.random(), isOpened: isOpened, keepCollapsedContent: true, className: cn('navbar-collapse', classNameCollapse) }, restCollapse),
          childrenCollapse
        ), children)
      ) : React.createElement(
        'nav',
...
NavBar = styled(NavBar).withConfig({
  ...
  componentId: 'NavBar__NavBar-svecag'
})(['', ''], function (props) {
