  ...
  _createClass(NavBar, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'children', 'theme', 'toggler', 'brand', 'collapse', 'fullWidth']); // eslint-disable-line no-unused-vars
      ...
      return fullWidth ? React.createElement(
        'nav',
        _extends({ className: cn('navbar', className) }, rest),
        _jsx(Container, {}, void 0, toggler && _jsx(NavBarToggler, {
