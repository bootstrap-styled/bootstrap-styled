...
var ButtonToolbar = function (_React$Component) {
  ...
  _createClass(ButtonToolbar, [{
    ...
    value: function render() {
      ...
      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'btn-toolbar'), cssModule);
...
ButtonToolbar = (0, _styledComponents2.default)(ButtonToolbar).withConfig({
  displayName: 'ButtonToolbar__ButtonToolbar',
  componentId: 'ButtonToolbar__ButtonToolbar-9692hh'
})(['', '  '], function (props) {
