  ...
  _createClass(ButtonGroup, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          rest = _objectWithoutProperties(_props2, ['className', 'theme', 'btn-toolbar']); // eslint-disable-line no-unused-vars
      ...
      var name = rest.name,
          ...
          restAfterChildContext = _objectWithoutProperties(rest, ['name', 'selectedValue', 'onChange', 'children']); // eslint-disable-line no-unused-vars
