...
var renderComponentUsingTheme = function renderComponentUsingTheme() {
  var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return (0, _enzyme.mount)(_jsx(_BootstrapProvider2.default, {}, void 0, _react2.default.createElement(_Fa2.default, props)));
};
describe('<Fa />', function () {
  ...
  it('should render an <Fa> with children', function () {
    var renderedComponent = renderComponent({
      children: children
    });
  ...
  it('should render an <Fa> with children with a theme', function () {
    var renderedComponent = renderComponentUsingTheme({
      children: children
    });
    expect(renderedComponent.contains(children)).toEqual(true);
