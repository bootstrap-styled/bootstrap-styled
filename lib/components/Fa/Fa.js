  ...
  _createClass(Fa, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          size = _props.size,
          color = _props.color,
          rest = _objectWithoutProperties(_props, ['className', 'size', 'color']);

      var classes = (0, _classnames2.default)(className, 'fa', size ? 'fa-' + size : false, color ? 'text-' + color : false);
      return _jsx('i', {
        className: (0, _classnames2.default)(classes, Object.keys(rest).map(function (key) {
          return 'fa-' + key;
        }))
      });
