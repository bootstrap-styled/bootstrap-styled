...
function composeLink(RouterLink) {
  var Link = function (_React$Component) {
    ...
    _createClass(Link, [{
      ...
      value: function render() {
        ...
        return theme['$enable-dynamic-links'] ? _react2.default.createElement(
          RouterLink,
          _extends({ className: className, to: to }, rest),
          children
        ) : _react2.default.createElement(
          _A2.default,
          _extends({ className: className, href: to }, rest),
          children
        );
  ...
  Link = (0, _styledComponents2.default)(Link).withConfig({
    ...
    componentId: 'composeLink__Link-1ph74nr'
  })(['', ''], function (props) {
  ...
  return (0, _styledComponents.withTheme)(Link);
}