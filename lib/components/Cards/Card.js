  ...
  _createClass(Card, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'children', 'theme', 'backgroundColor', 'borderColor']); // eslint-disable-line no-unused-vars
...
Card = (0, _styledComponents2.default)(Card).withConfig({
  ...
  componentId: 'Card__Card-1jav5n6'
})(['', ''], function (props) {
