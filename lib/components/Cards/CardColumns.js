...
var CardColumns = function (_React$Component) {
  ...
  _createClass(CardColumns, [{
    ...
    value: function render() {
      ...
      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'card-columns'), cssModule);
...
CardColumns = (0, _styledComponents2.default)(CardColumns).withConfig({
  displayName: 'CardColumns__CardColumns',
  componentId: 'CardColumns__CardColumns-1c1ovnh'
})(['', ''], function (props) {
