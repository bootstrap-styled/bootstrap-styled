...
var renderComponent = function renderComponent() {
  ...
  return (0, _enzyme.shallow)(_react2.default.createElement(_FormFeedback2.default, props));
};

var renderComponentUsingTheme = function renderComponentUsingTheme() {
  var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return (0, _enzyme.mount)(_jsx(_BootstrapProvider2.default, {}, void 0, _react2.default.createElement(_FormFeedback2.default, props)));
};
