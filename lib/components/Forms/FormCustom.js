...
var FormCustom = function (_React$Component) {
  ...
  _createClass(FormCustom, [{
    ...
    value: function render() {
      ...
      var CustomInput = radio ? _react2.default.createElement(_Input2.default, _extends({ type: 'radio', id: radio.id, name: radio.name, className: 'custom-control-input' }, attributes)) : _react2.default.createElement(_Input2.default, _extends({ type: 'checkbox', className: 'custom-control-input' }, attributes));
      return _jsx(_Label2.default, {
        className: classes
      }, void 0, CustomInput, _ref, _jsx('span', {
