...
describe('<Button />', function () {
  ...
  it('should have a function onClick not called when disabled is true', function () {
    var renderedComponent = renderComponentUsingTheme({
      onClick: onClick,
      disabled: true
    });
    renderedComponent.find('Button').simulate('click', { preventDefault: function preventDefault() {} });
