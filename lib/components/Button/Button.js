  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          Tag = _props.tag,
          theme = _props.theme,
          attributes = _objectWithoutProperties(_props, ['active', 'block', 'className', 'cssModule', 'dropup', 'dropdown-toggle', 'color', 'outline', 'size', 'getRef', 'tag', 'theme']);

      var focus = this.state.focus;


      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'btn', 'btn' + (outline ? '-outline' : '') + '-' + color, size ? 'btn-' + size : false, block ? 'btn-block' : false, dropup, focus, { 'dropdown-toggle': dropdownToggle }, { active: active, disabled: this.props.disabled }), cssModule);
