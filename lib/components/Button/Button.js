...
var Button = function (_React$Component) {
  ...
  function Button() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Button.__proto__ || Object.getPrototypeOf(Button)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function (e) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          Tag = _props.tag,
          theme = _props.theme,
          attributes = _objectWithoutProperties(_props, ['active', 'block', 'className', 'cssModule', 'dropup', 'color', 'outline', 'size', 'getRef', 'tag', 'theme']);

      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'btn', 'btn' + (outline ? '-outline' : '') + '-' + color, size ? 'btn-' + size : false, block ? 'btn-block' : false, dropup, { active: active, disabled: this.props.disabled }), cssModule);
