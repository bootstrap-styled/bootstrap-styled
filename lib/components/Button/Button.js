...
var Button = function (_React$Component) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'btn', 'btn' + (outline ? '-outline' : '') + '-' + color, size ? 'btn-' + size : false, block ? 'btn-block' : false, dropup, focus, { active: active, disabled: this.props.disabled }), cssModule);
