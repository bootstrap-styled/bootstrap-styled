  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['theme', 'className', 'disabled', 'outline', 'dropup', 'children']); // eslint-disable-line
