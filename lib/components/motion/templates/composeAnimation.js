  ...
  var HOC = function (_React$Component) {
    ...
    function HOC() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HOC.__proto__ || Object.getPrototypeOf(HOC)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        var animationName = makeAnimation(distance);
    ...
    _createClass(HOC, [{
      ...
      value: function render() {
        var _omit = (0, _tools.omit)(this.props, ['distance', 'duration', 'timingFunction', 'delay', 'iterations', 'direction', 'fillMode', 'playState', 'backfaceVisibility']),
