  ...
  var HOC = function (_React$Component) {
    ...
    _createClass(HOC, [{
      ...
      value: function render() {
        var _omit = (0, _lodash2.default)(this.props, ['theme', 'duration', 'timingFunction', 'delay', 'iterations', 'direction', 'fillMode', 'playState', 'keyframes', 'distance', 'degree', 'perspective', 'backfaceVisibility', 'amplification', 'rotation']),
