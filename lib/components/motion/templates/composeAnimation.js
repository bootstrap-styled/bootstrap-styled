  ...
  var HOC = function (_React$Component) {
    ...
    _createClass(HOC, [{
      ...
      value: function render() {
        var _omit = (0, _tools.omit)(this.props, ['theme', 'distance', 'duration', 'timingFunction', 'delay', 'iterations', 'direction', 'fillMode', 'playState', 'backfaceVisibility', 'keyframes']),
