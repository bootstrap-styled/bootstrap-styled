...
describe('composeAnimation', function () {
  ...
  beforeAll(function () {
    makeEffect = function makeEffect(distance) {
      return 'animationNameSuccess-' + distance;
    };
  ...
  var _ref2 = _jsx(AbstractAnimation, {}, void 0, 'Test');
  ...
  var _ref3 = _jsx(AbstractAnimation, {
    distance: '1337',
    duration: '2s',
  ...
  var _ref4 = _jsx(AbstractAnimation, {
    distance: '1337',
    duration: '2s',
    timingFunction: 'linear',
    delay: '1s',
  ...
  var _ref5 = _jsx(AbstractAnimation, {
    distance: '1337',
    duration: '2s',
    timingFunction: 'linear',
    delay: '1s',
  ...
  var _ref6 = _jsx(AbstractAnimation, {
    distance: '1337',
    duration: '2s',
    timingFunction: 'linear',
    delay: '1s',
  ...
  var _ref7 = _jsx(AbstractAnimation, {
    distance: '1337',
    duration: '2s',
    timingFunction: 'linear',
    delay: '1s',
  ...
  var _ref8 = _jsx(AbstractAnimation, {
    distance: '1337',
    duration: '2s',
    timingFunction: 'linear',
    delay: '1s',
  ...
  var _ref9 = _jsx(AbstractAnimation, {
    distance: '1337',
    duration: '2s',
    timingFunction: 'linear',
    delay: '1s',
