...
describe('motion keyframes utils', function () {
  ...
  describe('makeKeyframe', function () {
    it('should makeKeyframe', function () {
      var distance = '10px';
      expect((0, _makeKeyframe2.default)(_styledFade.makeFadeIn, { distance: distance }, userKeyframes)).toBe('jTitkM');
    });
    ...
    it('should makeKeyframe and apply user keyframe', function () {
      ...
      expect((0, _makeKeyframe2.default)(_styledFade.makeFadeIn, { distance: distance }, userKeyframe)).toBe('cVHrnJ');
    });
  });
