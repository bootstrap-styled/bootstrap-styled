...
describe('<Input />', function () {
  ...
  it('should have a class form-check-input if addon: false with a theme', function () {
    var renderedComponent = renderComponentUsingTheme({
      type: 'checkbox',
      addon: false
    });
  ...
  it('should NOT have a class form-check-input if addon: true with a theme', function () {
    var renderedComponent = renderComponentUsingTheme({
      type: 'checkbox',
      addon: true
    });
