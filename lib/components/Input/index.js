  ...
  _createClass(Input, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          attributes = _objectWithoutProperties(_props, ['className', 'cssModule', 'theme', 'type', 'size', 'state', 'tag', 'addon', 'static', 'getRef']);
      ...
      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, state ? 'form-control-' + state : false, size ? 'form-control-' + size : false, formControlClass), cssModule);
...
Input = (0, _styledComponents2.default)(Input).withConfig({
  ...
  componentId: 'Input__Input-1uik2vy'
})(['', ''], function (props) {
