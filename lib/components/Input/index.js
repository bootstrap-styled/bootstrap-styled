  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(Tag, _extends({
        className: (0, _tools.mapToCssModules)((0, _classnames2.default)(className, formControlClass, (_cn = {}, _defineProperty(_cn, 'form-control-' + state, state), _defineProperty(_cn, 'form-control-' + size, size), _cn)), cssModule),
        ref: getRef
      }, attributes));
