...
var Input = function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return React.createElement('input', _extends({ className: cn(className, { indeterminate: indeterminate, focus: focus }) }, rest, optional, { onChange: this.handleChange }));
    }
  }]);
...
Input = styled(Input).withConfig({
  ...
  componentId: 'Input__Input-1s1scl4'
})(['', ''], function (props) {
