  ...
  _createClass(Row, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme']),
          ...
          Tag = _omit.tag,
          attributes = _objectWithoutProperties(_omit, ['className', 'tag']);

      return _react2.default.createElement(Tag, _extends({ className: (0, _classnames2.default)(className, 'row') }, attributes));
