...
var Label = function Label(props) {
  ...
  var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, colClasses, (_cn2 = {
    'sr-only': hidden,
    disabled: check && inline && disabled,
    'col-form-label': colClasses.length
  }, _defineProperty(_cn2, 'col-form-label-' + size, size), _defineProperty(_cn2, 'form-check-' + (inline ? 'inline' : 'label'), check), _cn2)), cssModule);

  return _react2.default.createElement(Tag, _extends({ className: classes, htmlFor: htmlFor }, attributes));
};
