  ...
  _createClass(Strong, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme']),
          ...
          attributes = _objectWithoutProperties(_omit, ['className', 'color', 'cssModule']);

      return _react2.default.createElement('strong', _extends({
        className: (0, _tools.mapToCssModules)((0, _classnames2.default)(className, _defineProperty({}, 'text-' + color, color)), cssModule)
      }, attributes));
