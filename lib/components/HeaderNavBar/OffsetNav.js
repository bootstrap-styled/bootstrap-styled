...
var OffsetNav = function (_React$Component) {
  ...
  _createClass(OffsetNav, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'elementWidth', animationPush]),
          ...
          rest = _objectWithoutProperties(_omit, ['className', 'children', 'active', 'dismiss', 'menu-right', 'animation-push']);
