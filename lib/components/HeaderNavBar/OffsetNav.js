  ...
  _createClass(OffsetNav, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'elementWidth', 'animation-push']),
          ...
          attributes = _objectWithoutProperties(_omit, ['className', 'children', 'active', 'dismiss', 'menuClose', 'offsetColor', 'menu-right']);
      ...
      return _react2.default.createElement(
        'div',
        _extends({
          className: (0, _classnames2.default)(cssClasses, { active: active })
        }, attributes),
