...
var OffsetNavUnstyled = function (_React$Component) {
  ...
  _createClass(OffsetNavUnstyled, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'elementWidth', 'animation-push', 'showMenu']),
...
var OffsetNav = (0, _styledComponents2.default)(OffsetNavUnstyled).withConfig({
  ...
  return '\n    width: ' + (props.elementWidth ? props.elementWidth : props.theme['$menu-push-width']) + ';\n    height: 100%;\n    background-color: white;\n    z-index: ' + props.theme['$zindex-menu-push'] + ';\n    ' + (0, _conditional.ifThen)(props.showMenu, (0, _breakpoints.mediaBreakpointUp)(props.showMenu, props.theme['$grid-breakpoints'], 'position: absolute;\n            top: 0;')) + '\n  ';
});
