  ...
  _createClass(OffsetNav, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'children', 'active', 'menuClose', 'dismiss', 'menu-right', 'animation-push', 'theme', 'elementWidth']); // eslint-disable-line no-unused-vars
