  ...
  _createClass(OffsetNav, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'elementWidth', 'animation-push']),
          ...
          attributes = _objectWithoutProperties(_omit, ['className', 'children', 'active', 'dismiss', 'menuClose', 'menu-right']);

      var menuDirectionClassNames = menuRight ? 'menu-right' : 'menu-left';
      return _react2.default.createElement(
        'div',
        _extends({
          className: (0, _classnames2.default)(className, menuDirectionClassNames, { active: active })
        }, attributes),
        menuClose && _jsx(_Close2.default, {
          'aria-label': 'Close',
          onDismiss: dismiss
        }),
        children
