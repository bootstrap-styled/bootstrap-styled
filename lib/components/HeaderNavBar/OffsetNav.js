  ...
  _createClass(OffsetNav, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          theme = _props.theme,
          rest = _objectWithoutProperties(_props, ['className', 'children', 'active', 'dismiss', 'menu-right', 'animation-push', 'theme']); // eslint-disable-line no-unused-vars
...
OffsetNav = (0, _styledComponents2.default)(OffsetNav).withConfig({
  ...
  componentId: 'OffsetNav__OffsetNav-151erna'
})(['', ''], function (props) {
