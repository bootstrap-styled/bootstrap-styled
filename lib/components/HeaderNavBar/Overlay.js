  ...
  _createClass(Overlay, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          theme = _props.theme,
          rest = _objectWithoutProperties(_props, ['className', 'children', 'active', 'theme']); // eslint-disable-line no-unused-vars


      var cssClasses = (0, _classnames2.default)(className, 'fade', active ? 'show' : false);
...
Overlay = (0, _styledComponents2.default)(Overlay).withConfig({
  ...
  componentId: 'Overlay__Overlay-cybl0'
})(['', ''], function (props) {
