  ...
  _createClass(HeaderNavBar, [{
    ...
    value: function render() {
      ...
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'belowHeader']),
          ...
          attributesTemp = _objectWithoutProperties(_omit, ['className', 'children', 'cssModule', 'button', 'noOverlay', 'menuClose', 'offsetNavWidth', 'nav-top', 'menu-right', 'animation-push', 'light', 'inverse', 'fixed', 'sticky', 'color', 'offsetColor', 'alwaysShow', 'shadowHeader']);
