...
var HeaderNavBar = function (_React$Component) {
  ...
  function HeaderNavBar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HeaderNavBar.__proto__ || Object.getPrototypeOf(HeaderNavBar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (animationPush) {
        var direction = menuRight ? document.getElementById('wrapper').classList.toggle('right') : document.getElementById('wrapper').classList.toggle('left');
  ...
  _createClass(HeaderNavBar, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          noOverlay = _props['no-overlay'],
          restTmp = _objectWithoutProperties(_props, ['className', 'children', 'theme', 'button', 'nav-top', 'menu-right', 'navbar-inverse', 'bg-inverse', 'navbar-light', 'bg-faded', 'static-top', 'sticky-top', 'fixed-top', 'fixed-bottom', 'animation-push', 'no-overlay']);
      ...
      var OffsetMenuAnimated = animationPush ? _jsx(OffsetNavPush, {
        active: this.state.show,
        'menu-right': menuRight,
        'animation-push': animationPush
      }, void 0, children) : _jsx(OffsetNavSlide, {
        active: this.state.show,
        'menu-right': menuRight,
        'animation-push': animationPush
      }, void 0, children);

      return _jsx('div', {}, void 0, !noOverlay && _jsx(Overlay, {
        active: this.state.show,
