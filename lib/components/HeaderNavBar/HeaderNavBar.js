  ...
  _createClass(HeaderNavBar, [{
    ...
    value: function render() {
      ...
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'belowHeader']),
          ...
          attributesTemp = _objectWithoutProperties(_omit, ['className', 'children', 'button', 'noOverlay', 'menuClose', 'offsetNavWidth', 'nav-top', 'menu-right', 'animation-push', 'light', 'inverse', 'fixed', 'sticky', 'color', 'offsetColor', 'alwaysShow', 'shadowHeader']);
      ...
      var cssClasses = (0, _classnames2.default)('navbar', 'justify-content-between', 'flex-row', className, (_cn = {
        'navbar-light': light,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Header2.default,
          _extends({ className: (0, _classnames2.default)(cssClasses), shadowHeader: shadowHeader }, attributes, { innerRef: function innerRef(header) {
              _this2.header = header;
            } }),
          !alwaysShow && _react2.default.createElement(ButtonToggle, _extends({ className: buttonClasses, onClick: this.handleClick }, restButton)),
