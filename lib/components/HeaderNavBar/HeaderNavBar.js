...
var HeaderNavBar = function (_React$Component) {
  ...
  _createClass(HeaderNavBar, [{
    ...
    value: function render() {
      ...
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'belowHeader', 'alwaysShow']),
          ...
          sticky = _omit.sticky,
          color = _omit.color,
          attributesTemp = _objectWithoutProperties(_omit, ['className', 'children', 'button', 'noOverlay', 'menuClose', 'offsetNavWidth', 'nav-top', 'menu-right', 'animation-push', 'light', 'inverse', 'fixed', 'sticky', 'color']);
