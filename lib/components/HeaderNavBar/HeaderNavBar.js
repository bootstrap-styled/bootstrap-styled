  ...
  _createClass(HeaderNavBar, [{
    ...
    value: function render() {
      ...
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'belowHeader']),
          ...
          navbarInverse = _omit['navbar-inverse'],
          bgInverse = _omit['bg-inverse'],
          navbarLight = _omit['navbar-light'],
          bgFaded = _omit['bg-faded'],
          staticTop = _omit['static-top'],
          stickyTop = _omit['sticky-top'],
          fixedTop = _omit['fixed-top'],
          fixedBottom = _omit['fixed-bottom'],
          animationPush = _omit['animation-push'],
          restTmp = _objectWithoutProperties(_omit, ['className', 'children', 'button', 'noOverlay', 'offsetNavWidth', 'nav-top', 'menu-right', 'navbar-inverse', 'bg-inverse', 'navbar-light', 'bg-faded', 'static-top', 'sticky-top', 'fixed-top', 'fixed-bottom', 'animation-push']);

      var _omit2 = (0, _lodash2.default)(restTmp, ['onClick']),
          rest = _objectWithoutProperties(_omit2, []);
