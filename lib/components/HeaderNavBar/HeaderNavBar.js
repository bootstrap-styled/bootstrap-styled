  ...
  _createClass(HeaderNavBar, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          restTmp = _objectWithoutProperties(_props, ['className', 'children', 'theme', 'button', 'belowHeader', 'nav-top', 'menu-right', 'navbar-inverse', 'bg-inverse', 'navbar-light', 'bg-faded', 'static-top', 'sticky-top', 'fixed-top', 'fixed-bottom', 'animation-push', 'no-overlay']);
