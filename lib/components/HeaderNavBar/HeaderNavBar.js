  ...
  _createClass(HeaderNavBar, [{
    ...
    value: function render() {
      ...
      var _omit = (0, _lodash2.default)(this.props, ['theme', 'belowHeader']),
          ...
          attributesTemp = _objectWithoutProperties(_omit, ['className', 'children', 'button', 'noOverlay', 'menuClose', 'offsetNavWidth', 'nav-top', 'menu-right', 'animation-push', 'light', 'inverse', 'fixed', 'sticky', 'color', 'alwaysShow']);
      ...
      return _jsx('div', {}, void 0, !noOverlay && _jsx(_Overlay2.default, {
        ...
        _Header2.default,
        _extends({ className: (0, _classnames2.default)(cssClasses) }, attributes, { innerRef: function innerRef(header) {
