...
var Collapse = function (_Component) {
  ...
  _createClass(Collapse, [{
    ...
    value: function render() {
      ...
      var _omit = (0, _tools.omit)(this.props, ['isOpen', 'delay', 'onOpened', 'onClosed']),
          navbar = _omit.navbar,
          className = _omit.className,
          cssModule = _omit.cssModule,
          theme = _omit.theme,
          Tag = _omit.tag,
          attributes = _objectWithoutProperties(_omit, ['navbar', 'className', 'cssModule', 'theme', 'tag']);
      ...
      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, collapseClass, navbar && 'navbar-collapse'), cssModule);
