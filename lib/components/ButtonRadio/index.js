  ...
  _createClass(ButtonRadio, [{
    ...
    value: function render() {
      ...
      return _jsx(_Label2.default, {
        className: (0, _classnames2.default)(className, 'btn', {
          active: optional.checked
        })
      }, void 0, _react2.default.createElement(_Input2.default, _extends({
        key: Math.random(),
        value: value,
        name: name,
        type: 'radio'
...
ButtonRadio.contextTypes = {
  buttonRadioGroup: _react2.default.PropTypes.object
};
