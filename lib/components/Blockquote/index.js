  ...
  _createClass(Blockquote, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['theme', 'className', 'reverse', 'children']); // eslint-disable-line no-unused-vars


      var classes = (0, _classnames2.default)(className, 'blockquote', reverse ? 'blockquote-reverse' : false);
...
Blockquote = (0, _styledComponents2.default)(Blockquote).withConfig({
