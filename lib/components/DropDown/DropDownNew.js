...
var DropDownNew = function (_React$Component) {
  _inherits(DropDownNew, _React$Component);
  ...
  function DropDownNew() {
    ...
    _classCallCheck(this, DropDownNew);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DropDownNew.__proto__ || Object.getPrototypeOf(DropDownNew)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      dropped: false
  ...
  _createClass(DropDownNew, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'children', 'theme', 'toggler']); // eslint-disable-line no-unused-vars


      var Toggler = toggler.component,
          classNameToggler = toggler.className,
          textToggler = toggler.text,
          restToggler = _objectWithoutProperties(toggler, ['component', 'className', 'text']);
...
DropDownNew = onClickOutside(DropDownNew, {
...
// eslint-disable-next-line no-class-assign
DropDownNew = styled(DropDownNew)(_templateObject, function (props) {
