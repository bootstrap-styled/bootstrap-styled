  ...
  _createClass(DropDown, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          menu = _props.menu; // eslint-disable-line no-unused-vars
      ...
      var dropdown = _jsx('div', {
        ...
        className: cn({ 'dropdown-hide': !dropped, 'dropdown-menu-left': leftMenu, 'dropdown-menu-right': rightMenu })
      }, void 0, children));

      if (this.props['dropdown-split']) {
        return _jsx('div', {
          className: cn(className, 'btn-group')
        }, void 0, React.createElement(
          Toggler,
