  ...
  _createClass(DropDown, [{
    ...
    value: function render() {
      ...
      var _props$buttonProps = this.props.buttonProps,
          ...
          dropdownContent = _props$buttonProps.dropdownContent,
          rest = _objectWithoutProperties(_props$buttonProps, ['href', 'value', 'className', 'dropdownContent']);

      var dropdown = _jsx('div', {}, void 0, React.createElement(
        Btn,
        _extends({}, rest, {
