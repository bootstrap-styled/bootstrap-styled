...
var Modal = function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function destroy() {
      ...
      document.body.className = (0, _tools.mapToCssModules)((0, _classnames2.default)(classes).trim(), this.props.cssModule);
      (0, _tools.setScrollbarWidth)(this.originalBodyPadding);
    }
  }, {
    key: 'hide',
    value: function hide() {
    ...
    value: function show() {
      ...
      document.body.className = (0, _tools.mapToCssModules)((0, _classnames2.default)(classes, 'modal-open'), this.props.cssModule);
...
Modal = (0, _styledComponents2.default)(Modal).withConfig({
  ...
  componentId: 'Modal__Modal-168om6x'
})(['', ''], function (props) {
