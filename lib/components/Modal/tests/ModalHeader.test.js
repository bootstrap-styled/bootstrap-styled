...
var renderComponentUsingTheme = function renderComponentUsingTheme() {
  var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return (0, _enzyme.mount)(_jsx(_BootstrapProvider2.default, {}, void 0, _react2.default.createElement(_ModalHeader2.default, props)));
};
...
describe('<ModalHeader />', function () {
  ...
  it('should render close button', function () {
    var renderedComponent = (0, _enzyme.shallow)(_jsx(_ModalHeader2.default, {
