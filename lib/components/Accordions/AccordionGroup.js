...
var AccordionGroup = function (_React$Component) {
  ...
  _createClass(AccordionGroup, [{
    ...
    value: function render() {
      ...
      var activeAccordionName = attributes.activeAccordionName,
          onClick = attributes.onClick,
          headingComponent = attributes['heading-component'],
          restAfterChildContext = _objectWithoutProperties(attributes, ['activeAccordionName', 'onClick', 'heading-component']);
...
AccordionGroup.childContextTypes = {
  accordionGroup: _react2.default.PropTypes.object
};
