  ...
  _createClass(Accordion, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'name', 'component', 'children', 'heading']); // eslint-disable-line no-unused-vars


      var fixedHeight = rest.fixedHeight,
          springConfig = rest.springConfig,
          keepCollapsedContent = rest.keepCollapsedContent,
          onRest = rest.onRest,
          onHeightReady = rest.onHeightReady,
          restAfterCollapse = _objectWithoutProperties(rest, ['fixedHeight', 'springConfig', 'keepCollapsedContent', 'onRest', 'onHeightReady']); // eslint-disable-line no-unused-vars
      ...
      : _jsx('div', {
        ...
        onClick: optional.onClick
      }, void 0, _jsx(H5, {}, void 0, heading)) // eslint-disable-line jsx-a11y/no-static-element-interactions
      ;
