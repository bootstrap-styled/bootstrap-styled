...
describe('<Map />', function () {
  it('should render an <Map> tag without a theme', function () {
  ...
  it('should render a <map> tag with a theme', function () {
  ...
  it('should have class .map by default with a theme', function () {
    var renderedComponent = renderComponentUsingTheme({
      children: children
    });
