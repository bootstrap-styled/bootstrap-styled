  ...
  _createClass(Badge, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme']),
          ...
          pill = _omit.pill,
          Tag = _omit.tag,
          attributes = _objectWithoutProperties(_omit, ['theme', 'className', 'cssModule', 'color', 'pill', 'tag']);

      return _react2.default.createElement(Tag, _extends({
        className: (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'badge', _defineProperty({
          pill: pill
