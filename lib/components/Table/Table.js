...
var Table = function (_React$Component) {
  ...
  _createClass(Table, [{
    ...
    value: function render() {
      ...
      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, 'table', (_cn = {}, _defineProperty(_cn, 'table-' + size, size), _defineProperty(_cn, 'table-bordered', bordered), _defineProperty(_cn, 'table-striped', striped), _defineProperty(_cn, 'table-inverse', inverse), _defineProperty(_cn, 'table-hover', hover), _defineProperty(_cn, 'table-reflow', reflow), _cn)), cssModule);
