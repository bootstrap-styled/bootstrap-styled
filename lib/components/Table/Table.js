...
var Table = function (_React$Component) {
  ...
  _createClass(Table, [{
    ...
    value: function render() {
      ...
      var classes = (0, _tools.mapToCssModules)((0, _classnames2.default)(className, size ? 'table-' + size : false, // eslint-disable-line
      ...
      var table = _react2.default.createElement(Tag, _extends({}, attributes, { className: (0, _classnames2.default)('table', classes) }));

      if (responsive) {
        return _jsx(ResponsiveTag, {
          className: (0, _classnames2.default)('table-responsive', classes)
        }, void 0, table);
      }
      return table;
