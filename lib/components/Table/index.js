  ...
  _createClass(Table, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'theme', 'children', 'responsive', 'bordered', 'striped', 'hover', 'condensed']); // eslint-disable-line no-unused-vars
      ...
      if (responsive) {
        return _react2.default.createElement(
          ...
          _jsx('table', {
            className: (0, _classnames2.default)(className, 'table', {
              'table-bordered': bordered,
              'table-striped': striped,
              'table-hover': hover,
              'table-condensed': condensed
...
Table = (0, _styledComponents2.default)(Table).withConfig({
  ...
  componentId: 'Table__Table-1vfsnyk'
})(['', ''], function (props) {
