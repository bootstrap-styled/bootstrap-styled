  ...
  _createClass(HeaderNavBar, [{
    ...
    value: function render() {
      ...
      var navTopPush = composePush ? _jsx('div', {
        ...
        className: 'navbar-toggler navbar-toggler-icon hidden-sm-up float-xs-left m-2 p-3',
        type: 'button',
...
HeaderNavBar = styled(HeaderNavBar).withConfig({
  displayName: 'HeaderNavBarOld__HeaderNavBar',
  componentId: 'HeaderNavBarOld__HeaderNavBar-gpk37s'
})(['', ''], function (props) {
