...
var MenuAccount = function (_React$Component) {
  ...
  _createClass(MenuAccount, [{
    ...
    value: function render() {
      ...
      return _jsx('div', {
        className: (0, _classnames2.default)(className, 'nav-account')
      }, void 0, children);
...
MenuAccount = (0, _styledComponents2.default)(MenuAccount).withConfig({
  displayName: 'MenuAccount__MenuAccount',
  componentId: 'MenuAccount__MenuAccount-1k7fk57'
})(['', ''], function (props) {
