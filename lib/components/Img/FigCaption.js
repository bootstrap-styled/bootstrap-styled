  ...
  _createClass(FigCaption, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme']),
          ...
          right = _omit.right,
          attributes = _objectWithoutProperties(_omit, ['className', 'right']);

      return _react2.default.createElement('figcaption', _extends({
        className: (0, _classnames2.default)(className, 'figure-caption', {
          'text-right': right
        })
      }, attributes));
...
FigCaption = (0, _styledComponents2.default)(FigCaption).withConfig({
