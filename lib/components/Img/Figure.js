  ...
  _createClass(Figure, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          attributes = _objectWithoutProperties(_props, ['className']); // eslint-disable-line no-unused-vars

      return _react2.default.createElement('figure', _extends({ className: (0, _classnames2.default)('figure', className) }, attributes));
...
Figure = (0, _styledComponents2.default)(Figure).withConfig({
