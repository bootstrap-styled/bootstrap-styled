...
describe('<Legend />', function () {
  it('should render an <Legend> tag without a theme', function () {
  ...
  it('should render a <legend> tag with a theme', function () {
  ...
  it('should have class .legend by default with a theme', function () {
    var renderedComponent = renderComponentUsingTheme({
      children: children
    });
