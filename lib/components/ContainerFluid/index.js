...
ContainerFluid = styled(ContainerFluid)(_templateObject, function (props) {
  return '\n    ' + makeContainer(props.theme['$enable-flex'], props.theme['$enable-grid-classes'], props.theme['$grid-gutter-widths']) + '\n  ';
});
