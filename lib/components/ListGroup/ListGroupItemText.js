...
var ListGroupItemText = function (_React$Component) {
  ...
  function ListGroupItemText() {
    ...
    return _possibleConstructorReturn(this, (ListGroupItemText.__proto__ || Object.getPrototypeOf(ListGroupItemText)).apply(this, arguments));
  }
  ...
  _createClass(ListGroupItemText, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(Tag, _extends({
        className: (0, _classnames2.default)(className, 'list-group-item-text')
      }, attributes));
