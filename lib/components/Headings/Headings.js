...
var Headings = function (_React$Component) {
  ...
  _createClass(Headings, [{
    ...
    value: function render() {
      var _omit = (0, _lodash2.default)(this.props, ['theme']),
          ...
          lead = _omit.lead,
          Tag = _omit.tag,
          attributes = _objectWithoutProperties(_omit, ['className', 'color', 'cssModule', 'lead', 'tag']);

      return _react2.default.createElement(Tag, _extends({
        className: (0, _tools.mapToCssModules)((0, _classnames2.default)(className, _defineProperty({
          lead: lead
...
Headings = (0, _styledComponents2.default)(Headings).withConfig({
  displayName: 'Headings__Headings'
})(['', ''], function (props) {
